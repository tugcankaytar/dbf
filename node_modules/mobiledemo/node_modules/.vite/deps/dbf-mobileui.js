import {
  defineComponent,
  defineProps
} from "./chunk-IZLR5C45.js";

// node_modules/dbf-mobileui/dist/index.js
var baseStyles = `
:host {
...
var props2 = defineProps({
  side: "string",
  animation: "string"
});
function defineMobileDrawer() {
  defineComponent("dbf-mobile-drawer", {
    props: props2,
    styles: [
      baseStyles,
      surfaceStyles,
...
function defineMobileInput() {
  defineComponent("dbf-mobile-input", {
    props: props3,
    styles: [
      baseStyles,
      `
...
var props4 = defineProps({
  href: "string",
  variant: "string"
});
function defineMobileLink() {
  defineComponent("dbf-mobile-link", {
    props: props4,
    styles: [
      baseStyles,
      `
...
var props5 = defineProps({
  title: "string",
  back: "boolean",
  backlabel: "string"
});
function defineMobileNavbar() {
  defineComponent("dbf-mobile-navbar", {
    props: props5,
    styles: [
      baseStyles,
      `
...
//# sourceMappingURL=dbf-mobileui.js.map
