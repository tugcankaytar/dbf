...
var props3 = (0, import_dbf_core4.defineProps)({
  label: "string",
  placeholder: "string",
  value: "string",
  type: "string"
...
function defineMobileInput() {
  (0, import_dbf_core4.defineComponent)("dbf-mobile-input", {
    props: props3,
    styles: [
      baseStyles,
      `
...
var props4 = (0, import_dbf_core5.defineProps)({
  href: "string",
  variant: "string"
});
function defineMobileLink() {
  (0, import_dbf_core5.defineComponent)("dbf-mobile-link", {
    props: props4,
    styles: [
      baseStyles,
      `
...
function defineMobileList() {
  (0, import_dbf_core6.defineComponent)("dbf-mobile-list", {
    styles: [
      baseStyles,
      surfaceStyles,
      `
...
function defineMobileListItem() {
  (0, import_dbf_core7.defineComponent)("dbf-mobile-list-item", {
    styles: [
      baseStyles,
      `
      :host {
...
var props5 = (0, import_dbf_core8.defineProps)({
  title: "string",
  back: "boolean",
  backlabel: "string"
});
function defineMobileNavbar() {
  (0, import_dbf_core8.defineComponent)("dbf-mobile-navbar", {
    props: props5,
    styles: [
      baseStyles,
      `
...
function defineMobileToolbar() {
  (0, import_dbf_core9.defineComponent)("dbf-mobile-toolbar", {
    styles: [
      baseStyles,
      `
      :host {
...
function defineMobilePage() {
  (0, import_dbf_core10.defineComponent)("dbf-mobile-page", {
    styles: [
      baseStyles,
      `
      :host {
