...
import { defineComponent as defineComponent4, defineProps as defineProps3 } from "dbf-core";
...
function defineMobileInput() {
  defineComponent4("dbf-mobile-input", {
    props: props3,
    styles: [
      baseStyles,
      `
...
import { defineComponent as defineComponent5, defineProps as defineProps4 } from "dbf-core";
var props4 = defineProps4({
  href: "string",
  variant: "string"
});
function defineMobileLink() {
  defineComponent5("dbf-mobile-link", {
    props: props4,
    styles: [
      baseStyles,
      `
...
import { defineComponent as defineComponent6 } from "dbf-core";
function defineMobileList() {
  defineComponent6("dbf-mobile-list", {
    styles: [
      baseStyles,
      surfaceStyles,
      `
...
function defineMobileListItem() {
  defineComponent7("dbf-mobile-list-item", {
    styles: [
      baseStyles,
      `
      :host {
...
import { defineComponent as defineComponent8, defineProps as defineProps5 } from "dbf-core";
...
function defineMobileNavbar() {
  defineComponent8("dbf-mobile-navbar", {
    props: props5,
    styles: [
      baseStyles,
      `
...
import { defineComponent as defineComponent9 } from "dbf-core";
function defineMobileToolbar() {
  defineComponent9("dbf-mobile-toolbar", {
    styles: [
      baseStyles,
      `
      :host {
...
function defineMobilePage() {
  defineComponent10("dbf-mobile-page", {
    styles: [
      baseStyles,
      `
      :host {
